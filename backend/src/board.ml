...
module Game = struct
  ...
  *)
  ...
  (* 
     Type representing the position of something on the board (x, y, player = 0, 1 or 2)
     0 if there is no piece placed at the position
  *)
